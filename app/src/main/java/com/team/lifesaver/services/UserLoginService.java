...
public class UserLoginService {
    private static String url = "http://172.20.216.165:25916/services/lifesaver/login";
    public static void loginService(final UserLoginHandler handler) throws JSONException {
        ...
        RestClient.post(handler.getContext(), url, entity, "application/json", new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    handler.login(statusCode, headers, response);
